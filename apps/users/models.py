...
class Doctor(User):
    ...
    middle_name = models.CharField(max_length=50, verbose_name='Отчетво')
...
#     advanced_training = models.TextField(blank=True, null=True)
#
#     class Meta:
...
#
#     def __str__(self):
#         return f"{self.doctor} {self.qualification}"
